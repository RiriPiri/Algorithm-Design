...
# Trauma: Emergency and Urgent orders only
orders = [
    {"id": 1, "ward": "ICU", "urgency": "Emergency", "medication": "Painkiller"},
    {"id": 2, "ward": "Ward A", "urgency": "Urgent", "medication": "Blood Thinner"},
    {"id": 3, "ward": "Operating Room", "urgency": "Emergency", "medication": "Anesthesia"},
    {"id": 4, "ward": "Ward C", "urgency": "Urgent", "medication": "Sedative"}
]
...
class Robot(Thread):
    ...
    def run(self):
        while self.orders:
            ...
            is_large_obstacle = random.choices([True, False], weights=[0.8, 0.2])[0]  # 80% large
